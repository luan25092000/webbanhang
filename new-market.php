        ...
        <?php include 'header.php'; ?>
            <div class="container mt-3 mb-3">
                <div class="row mb-4">
                    ...
                    <small><a href="./index.php" class="text-dark">Trang chủ</a> <i class="fas fa-angle-double-right"></i> <a href="./new.php" class="text-dark">Tin tức</a> <i class="fas fa-angle-double-right"></i> <span class="introduce">Tin thị trường</span></small>

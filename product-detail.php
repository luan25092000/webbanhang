...
<div class="wrapper">
   ...
   <div class="container mt-4 mb-4">
      <div class="row">
         ...
         <div class="col-lg-9">
         <small><a href="./index.php" class="text-dark">Trang chủ</a> <i class="fas fa-angle-double-right"></i> <a href="./index.php" class="text-dark">Sản phẩm</a> <i class="fas fa-angle-double-right"></i> <span class="introduce">Chi tiết sản phẩm</span></small>
             <div class="row mt-4">
    ...
    Áo Công Sở Tay Búp Sang Trọng – Kiểu Dáng Thời Trang, Chất Liệu Tơ Gân Mềm Mịn, Gam Màu Tươi Tắn – Mang Đến Vẻ Ngoài Trẻ Trung, Duyên Dáng Cho Bạn Gái. Giá 210.000 VNĐ, Còn 125.000 VNĐ, Giảm 40%.&nbsp;</p>
                    <iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fluankma&width=450&layout=standard&action=like&size=small&share=true&height=35&appId=415196006363533" width="450" height="35" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                    <div class="quantity-input">
                        <h5>Số lượng</h5>
                        <input style="width:20%; text-center" type="number" value="1" class="text ng-valid ng-dirty ng-valid-number ng-touched" ng-model="InputQuantity" ng-init="InputQuantity=1">
                    </div>
                    <div class="btn-buy mt-4">
                    <button class="btn btn-add-to-cart" ><i class="fas fa-shopping-cart"></i>Thêm vào giỏ hàng</button>
               ...
               - Áo công sở được thiết kế đơn giản, nhưng không kém phần tinh tế, với form áo vừa vặn, cổ bẻ, điểm nhấn ở phần tay búp sen được may cách điệu, đẹp mắt. <br />
Điểm nổi bật
- Chất liệu tơ gân mềm mịn, thông thoáng và thấm hút mồ hôi tốt, nên tạo được cảm giác thoải mái cho người mặc
- Ba gam màu: hồng, xanh, trắng tươi tắn, trẻ trung, rất dễ để kết hợp với chân váy công sở, quần tây, jeans,… tạo vẻ ngoài chỉn chu khi đi làm. <br>
...
- Kích cỡ: Freesize     <br>
- Thời gian cuối giao sản phẩm đến hết 23/05/2015, không giao sản phẩm ngày chủ nhật. <br>
- Khách hàng không bù thêm tiền khi nhận sản phẩm. <br>
- Khách hàng vui lòng kiểm tra sản phẩm trước khi nhận hàng, Hotdeal không chịu trách nhiệm đổi trả sản phẩm sau khi giao hàng. <br>
               </div>
            </div>
                 </div>
             </div>

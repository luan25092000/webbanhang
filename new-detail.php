            ...
            <div class="row mb-4">
                <div class="col-lg-3 col-md-12">
                    <div class="menu-news">
                        ...
                        <ul>
                            <li><i class="fas fa-arrow-circle-right"></i> <a href="./new-promotion.php">TIN KHUYẾN
                                    MÃI</a></li>
                            <hr />
                            <li><i class="fas fa-arrow-circle-right"></i> <a href="./new-market.php">TIN THỊ TRƯỜNG</a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div classs="news-block">
                                ...
                                <div class="news-item">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 title-news">
                                            <a href="./new-detail.php">NHỮNG GÓC KHUẤT CỦA NGHỀ STYLIST CHO SAO
                                                HOLLYWOOD</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-9 col-md-12">
                    <small><a href="./index.php" class="text-dark">Trang chủ</a> <i
                            class="fas fa-angle-double-right"></i> <a href="./new.php" class="text-dark">Tin tức</a> <i
                            class="fas fa-angle-double-right"></i> <span class="introduce">NHỮNG CÔ NÀNG TRẺ TRUNG TRONG

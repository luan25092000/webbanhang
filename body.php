            ...
            <form action="" method="get">
                <div class="product-item-box">
                    <div class="product-item">
                        <div class="image">
                            <a href="">
                                <img src="./img/product/5.jpg" alt="1" width="100%" height="100%" name="product-image" class="product-image" />
                            </a>
                            <a href="" class="more-info"><i class="fas fa-search"></i> XEM THÊM</a>
                        </div>
            ...
            <form action="" method="get">
                <div class="product-item-box">
                        <div class="product-item">
                            <div class="image">
                                <a href="">
                                    <img src="./img/product/6.jpg" alt="2" width="100%" height="100%" class="product-image"/>
                                </a>
                                <a href="" class="more-info"><i class="fas fa-search"></i> XEM THÊM</a>
                            </div>
            ...
            <form action="" method="get">
                    <div class="product-item-box">
                        <div class="product-item">
                            <div class="image">
                                <a href="">
                                    <img src="./img/product/7.jpg" alt="3" width="100%" height="100%" class="product-image" />
                                </a>
                                <a href="" class="more-info"><i class="fas fa-search"></i> XEM THÊM</a>
                            </div>
            ...
            <form action="" method="get">
                    <div class="product-item-box">
                        <div class="product-item">
                            <div class="image">
                                <a href="">
                                    <img src="./img/product/8.jpg" alt="4" width="100%" height="100%" class="product-image"/>
                                </a>
                                <a href="" class="more-info"><i class="fas fa-search"></i> XEM THÊM</a>
                            </div>

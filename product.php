                        ...
                        <div class="product-item-box">
                            <div class="product-item">
                                <div class="image">
                                    ...
                                    <a href="./product-detail.php" class="more-info"><i class="fas fa-search"></i> XEM
                                        THÊM</a>
                    ...
                    <form action="" method="get">
                        <div class="product-item-box">
                            <div class="product-item">
                                <div class="image">
                                    <a href="">
                                        <img src="./img/product/7.jpg" alt="2" width="100%" height="100%"
                                            class="product-image product-image360" />
                                    </a>
                                    <a href="./product-detail.php" class="more-info"><i class="fas fa-search"></i> XEM
                                        THÊM</a>
                    ...
                    <form action="" method="get">
                        <div class="product-item-box">
                            <div class="product-item">
                                <div class="image">
                                    <a href="">
                                        <img src="./img/product/5.jpg" alt="2" width="100%" height="100%"
                                            class="product-image product-image360" />
                                    </a>
                                    <a href="./product-detail.php" class="more-info"><i class="fas fa-search"></i> XEM
                                        THÊM</a>
                    ...
                    <form action="" method="get">
                        <div class="product-item-box">
                            <div class="product-item">
                                <div class="image">
                                    <a href="">
                                        <img src="./img/product/4.jpg" alt="2" width="100%" height="100%"
                                            class="product-image product-image360" />
                                    </a>
                                    <a href="./product-detail.php" class="more-info"><i class="fas fa-search"></i> XEM
                                        THÊM</a>
                    ...
                    <form action="" method="get">
                        <div class="product-item-box">
                            <div class="product-item">
                                <div class="image">
                                    <a href="">
                                        <img src="./img/product/3.jpg" alt="2" width="100%" height="100%"
                                            class="product-image product-image360" />
                                    </a>
                                    <a href="./product-detail.php" class="more-info"><i class="fas fa-search"></i> XEM
                                        THÊM</a>
                    ...
                    <form action="" method="get">
                        <div class="product-item-box">
                            <div class="product-item">
                                <div class="image">
                                    <a href="">
                                        <img src="./img/product/1.jpg" alt="2" width="100%" height="100%"
                                            class="product-image product-image360" />
                                    </a>
                                    <a href="./product-detail.php" class="more-info"><i class="fas fa-search"></i> XEM
                                        THÊM</a>

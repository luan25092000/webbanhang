...
?>
        ...
        <ul class="nav nav-tabs mb-4">
            <li class="nav-item">
                <a class="nav-link active female-product" data-toggle="tab" href="#tabs" id="ThoiTrangNu">Thời Trang Nữ</a>
            </li>
            <li class="nav-item">
                <a class="nav-link female-product" id="AoThunNu" data-toggle="tab" href="#tabs">Áo Thun Nữ</a>
            </li>
            <li class="nav-item">
                <a class="nav-link female-product" data-toggle="tab" href="#tabs" id="AoSoMiNu">Áo Sơ Mi Nữ</a>
            </li>
            <li class="nav-item">
                <a class="nav-link female-product" data-toggle="tab" href="#tabs" id="VayNu">Váy Nữ</a>
            </li>
            <li class="nav-item">
                <a class="nav-link female-product" data-toggle="tab" href="#tabs" id="QuanNu">Quần Nữ</a>
            </li>
        </ul>
        ...
        <ul class="nav nav-tabs mb-4 mt-4">
            <li class="nav-item">
                <a class="nav-link active male-product" data-toggle="tab" href="#" id="ThoiTrangNam">Thời Trang Nam</a>
            </li>
            <li class="nav-item">
                <a class="nav-link male-product" data-toggle="tab" href="#" id="AoThunNam">Áo Thun Nam</a>
            </li>
            <li class="nav-item">
                <a class="nav-link male-product" data-toggle="tab" href="#" id="AoSoMiNam">Áo Sơ Mi Nam</a>
            </li>
            <li class="nav-item">
                <a class="nav-link male-product" data-toggle="tab" href="#" id="QuanNam">Quần Nam</a>
            </li>
            <li class="nav-item">
                <a class="nav-link male-product" data-toggle="tab" href="#" id="AoKhoacNam">Áo Khoác Nam</a>
            </li>
        </ul>
        <div class="row mb-4">

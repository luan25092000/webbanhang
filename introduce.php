            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="menu-about">
                        ...
                        <ul>
                            <li><i class="fas fa-angle-double-right"></i> <a href="./introduce.php">Về chúng tôi</a>
                            </li>
                            <li><i class="fas fa-angle-double-right"></i> <a href="./field.php">Lĩnh vực hoạt động</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="menu-header-introduce">
                        <small><a href="./index.php" class="text-dark">Trang chủ</a> <i
                                class="fas fa-angle-double-right"></i> <span class="introduce">Giới thiệu</span></small>
                        ...
                        <div class="content">
                            ...
                            <p>Royal Hotel - Khách sạn Hoàng Gia nằm giữa tuyến đường chính của khu du lịch, bên bờ vịnh
                                ...
                                hiện đại đạt tiêu chuẩn Quốc tế 5 sao. Trong đó có 150 phòng đặc biệt, 200 phòng cao cấp
                                100 phòng hạng sang, 150 phòng tiêu chuẩn.
                                Hệ thống nhà hàng sang trọng, không gian thoáng đãng, tươi mới, hiện đại phục vụ được
                                trên 10.000 thực khách.
                                Nhà hàng nằm trên tầng 21 của khách sạn là nơi có tầm nhìn lý tưởng bao quát khu du
                                lịch, chuyên phục các món ăn Âu, Trung Quốc và Việt nam và trên toàn thế giới với các
                                món ăn ngon được chế biến từ các đầu bếp chuyên nghiệp cùng với phong cảnh thiên nhiên
                                kỳ vĩ mà thiên nhiên ban tặng chắc chắn sẽ làm quý khách hài lòng. Vườn Thượng uyển trên
                                tầng 13 là nơi tổ chức các bữa tiệc ngoài trời, các chương trình Ga la, hát karaoke theo
